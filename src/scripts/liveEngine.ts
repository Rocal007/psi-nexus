...
export function updateDomWithChart(chart: CompleteNatalChart) {
  ...
  // 19. Update Human Design Chart & Agent
  updateHumanDesign(chart);
}
...
export function updateHumanDesign(chart: CompleteNatalChart) {
...
function updateBodygraphSvgElements(hd: HDChartData) {
  // Update Centers
...
function renderHdAgentResponse(promptKey: string) {
